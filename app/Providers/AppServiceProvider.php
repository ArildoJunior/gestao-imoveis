...
use Illuminate\Support\Facades\Blade; // Mantenha esta linha se você usa componentes Blade
...
{
    // Adicione estas linhas para registrar os componentes Blade (se você as usa)
